...
macro_rules! define_kernel_function {
    ($kfn:ident::$name:ident, -> $ret:ty, $impl_fun:ident) => {
    ...
    ($kfn:ident::$name:ident, $($args:ident:$types:ty),*, $impl_fun:ident) => {
        /// This is a kernel function, you can find more information about it [here](link)
        #[no_mangle]
        pub unsafe extern "C" fn $name($($args:$types,)*) {
            KernelFunctionName::$name;
            $impl_fun($($args,)*)
        }
    };

    ($kfn:ident::$name:ident, $($args:ident:$types:ty),*, -> $ret:ty, $impl_fun:ident) => {
        /// This is a kernel function, you can find more information about it [here](link)
        #[no_mangle]
